...
var scrolling = function(){
	...
	var object = document.querySelector(".horizontalstripe_even");
	...
	var red = Math.round(percentageScrolled) * 255;
	var blue = percentageScrolled * 100;
	console.log('red:', red);

	object.style.backgroundColor = `rgb(${ red },0,${blue})`;
